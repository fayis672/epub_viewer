  ...
  rendition.hooks.content.register((contents) => {
    ...
    doc.addEventListener('touchend', function (e) {
      if (hasActiveSelection()) {
        ...
        if (touchStartX !== null && currentTouchX !== null && touchStartTime !== null) {
          ...
          // Allow taps to proceed so they can deselect text
          if (!hasMoved && deltaX < 10 && deltaY < 10 && touchDuration < 300) {
            // Don't preventDefault - allow the tap to deselect
        ...
        // If it was a tap, don't preventDefault - let it through to deselect
      }
      // Reset tracking
      touchStartX = null;
      touchStartY = null;
    ...
    try {
      if (doc) {
        ...
        // Note: We don't block simple taps (which should deselect), only navigation clicks
        ...
        doc.addEventListener('touchend', function (e) {
          // Check if this was a simple tap (should allow deselection)
